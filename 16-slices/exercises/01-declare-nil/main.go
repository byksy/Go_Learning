...
func main() {
	...
	fmt.Printf("Names = Type: %T, Len= %d, isNil = %t\n", names, len(names), names == nil)
	fmt.Printf("distances = Type: %T, Len= %d, isNil = %t\n", distances, len(distances), distances == nil)
	fmt.Printf("data = Type: %T, Len= %d, isNil = %t\n", data, len(data), data == nil)
	fmt.Printf("ratios = Type: %T, Len= %d, isNil = %t\n", ratios, len(ratios), ratios == nil)
	fmt.Printf("alives = Type: %T, Len= %d, isNil = %t\n", alives, len(alives), alives == nil)
}
